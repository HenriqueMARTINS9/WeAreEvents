  ...
  const groups = useMemo<SeoGroup[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        description: "Bars, restaurants, discothèques, salles, espaces extérieurs et autres formats de lieux.",
        tone: "light",
        links: pickPages(
          [
            "bar-privatisable-paris",
            ...
            "salle-reception-paris",
            "salle-reunion-paris",
            "salle-de-conference-paris",
            "espace-exterieur-paris",
            "peniche-evenement-paris",
            "appartement-evenement-paris",
            "loft-evenement-paris",
            "maison-evenement-paris",
            "villa-evenement-paris",
            "chateau-evenement-paris",
            "domaine-evenement-paris",
            "hotel-evenement-paris",
            "jardin-evenement-paris",
            "terrasse-evenement-paris",
            "plage-privee-evenement-paris",
            "hangar-evenement-paris",
            "showroom-evenement-paris",
          ],
          pagesBySlug,
        ),
      },
      ...
      {
        title: "Par ambiance",
        description: "Calme, animée, festive, élégante, intimiste ou atypique : partez de l'atmosphère souhaitée.",
        tone: "light",
        links: pickPages(
          [
            ...
            "salle-ambiance-intimiste-paris",
            "salle-ambiance-atypique-paris",
            "salle-ambiance-chic-paris",
            "salle-ambiance-conviviale-paris",
            "salle-ambiance-lounge-paris",
            "salle-ambiance-premium-paris",
            "salle-ambiance-decontractee-paris",
            "salle-ambiance-boheme-paris",
            "salle-ambiance-moderne-paris",
            "salle-ambiance-industrielle-paris",
            "salle-ambiance-romantique-paris",
          ],
          pagesBySlug,
        ),
      },
      ...
      },
      {
        ...
        description: "Terrasse, jardin, piscine, projecteur, micro, Wi-Fi, système son, loge ou accès PMR.",
        tone: "dark",
        links: pickPages(
          [
            "salle-avec-tv-paris",
